...
<img width="6000" height="858" alt="image" src="https://github.com/user-attachments/assets/2a54d5e3-bb4a-4639-84eb-68fcb96aad53" />


**XGBoost model** is then used to translate complex movie attributes into a clear **go / no-go investment signal**.
